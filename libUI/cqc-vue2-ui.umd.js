(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["cqc-vue2-ui"] = factory(require("vue"));
	else
		root["cqc-vue2-ui"] = factory(root["Vue"]);
...
loading_icon.install = function (app) {
  return app.component(loading_icon.name, loading_icon);
};

/* harmony default export */ var packages_loading_icon = (loading_icon);
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/packages/button/button.vue?vue&type=template&id=3b94ea4f&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',{class:_vm.buttonClass,style:(_vm.styles),attrs:{"disabled":_vm.loading || _vm.disabled},on:{"click":function($event){return _vm.$emit('click')}}},[(_vm.icon && !_vm.loading && _vm.position === 'left')?_c('i',{class:("icon-" + _vm.position + " " + _vm.icon),staticStyle:{}}):_vm._e(),(_vm.loading)?_c('LoadingIcon'):_vm._e(),(_vm.$slots.default)?_c('span',[_vm._t("default")],2):_vm._e(),(_vm.icon && !_vm.loading && _vm.position === 'right')?_c('i',{class:("icon-" + _vm.position + " " + _vm.icon),staticStyle:{}}):_vm._e()],1)}
var staticRenderFns = []
...
/* harmony default export */ var props = ({
  type: {
    ...
    validator: function validator(val) {
      var types = ['primary', 'danger', 'success', 'warning', 'info', 'default'];

      if (val && !types.includes(val)) {
        throw new Error("cqc-button\u7684type\u5C5E\u6027\u5FC5\u987B\u4E3A:".concat(types.join(','), "\u4E2D\u7684\u4E00\u4E2A"));
      }
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-80[0].rules[0].use[1]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/packages/button/button.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var buttonvue_type_script_lang_js_ = ({
  ...
  computed: {
    buttonClass: function buttonClass() {
      return ['cqc-button', 'cqc-button-' + this.type, this.shadow && typeof this.shadow === 'boolean' && 'cqc-button-shadow'];
    },
...
button_button.install = function (app) {
  return app.component(button_button.name, button_button);
};
...
button_group.install = function (app) {
  return app.component(button_group.name, button_group);
};
...
/* harmony default export */ var compute = ({
  computed: {
    ...
    trackPath: function trackPath() {
      var _radius = this.radiu;
      var isDashboard = this.type === 'dashboard';
      return "\n        M 50 50\n        m 0 ".concat(isDashboard ? '' : '-').concat(_radius, "\n        a ").concat(_radius, " ").concat(_radius, " 0 1 1 0 ").concat(isDashboard ? '-' : '').concat(_radius * 2, "\n        a ").concat(_radius, " ").concat(_radius, " 0 1 1 0 ").concat(isDashboard ? '' : '-').concat(_radius * 2, "\n        ");
    },
    ...
    circlePathStyle: function circlePathStyle() {
      ...
      return {
        strokeDasharray: "".concat(this.perimeter * this.rate * (percentage / 100), "px, ").concat(this.perimeter, "px"),
        strokeDashoffset: this.strokeDashoffset,
...
/* harmony default export */ var progress = ({
  ...
  computed: {
    textClass: function textClass() {
      return ['cqc-progress-text', 'cqc-progress-text-' + this.textPosition];
    }
  },
  watch: {
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      var instanceRef = _this.$refs.instanceRef;

      if (instanceRef) {
        _this._width = instanceRef.clientWidth;

        _this.changeWidth(_this.percentage);
      }
    });
  },
  methods: {
    changeWidth: function changeWidth(percentage) {
      if (percentage > 100) percentage = 100;
      if (percentage < 0) percentage = 0;
...
progress.install = function (app) {
  return app.component(progress.name, progress);
};
...
/* harmony default export */ var message = ({
  ...
  computed: {
    ...
    classes: function classes() {
      return ['cqc-message', 'cqc-message-' + this.type];
    }
  },
  methods: {
    destroyFn: function destroyFn(cb) {
  ...
  render: function render() {
    ...
    return h("div", {
      ...
      "class": "cqc-message-icon ".concat(this.icon)
    }), this.msg]);
  }
});
...
function Message(msg) {
  ...
  opts.zIndex = ++zIndex;
  var MessageApp = external_commonjs_vue_commonjs2_vue_root_Vue_default().extend(message);
  var $vm = new MessageApp({
    propsData: {
      msg: msg,
      type: opts.type,
      zIndex: zIndex,
...
['success', 'info', 'warn', 'error'].forEach(function (type) {
  Message[type] = function (msg) {
    var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return Message(msg, _objectSpread2({
      type: type
    }, opts));
  };
});
...
/* harmony default export */ var drag_list_item = ({
  ...
  render: function render() {
    var h = arguments[0];
    var data = this.data;
    var _this$dragList = this.dragList,
        dragStart = _this$dragList.dragStart,
        dragEnd = _this$dragList.dragEnd,
        dragOver = _this$dragList.dragOver,
        drop = _this$dragList.drop;
    var Event = {
...
/* harmony default export */ var drag_list = ({
  ...
  methods: {
    makeKey: function makeKey(data) {
      data._dargKey = 0;
      data.forEach(function (e, i) {
        return e._dargKey = i + 1;
      });
    ...
    dragOver: function dragOver(e, data) {
      ...
      var instanceTop = this.$refs.instanceNode.getBoundingClientRect().top;
    ...
    dragEnd: function dragEnd() {
      ...
      if (this.dropPosition && this.dropData) {
        this.cloneData = JSON.parse(JSON.stringify(this.cloneData.filter(function (e) {
          return e._dargKey !== _this.dragData._dargKey;
        })));
        var index = this.cloneData.findIndex(function (e) {
          return e._dargKey === _this.dropData._dargKey;
        });
  ...
  render: function render() {
    ...
    var renderChild = function renderChild(data) {
      if (!data || data.length === 0) {
        return h("div", ["\u6682\u65E0\u6570\u636E"]);
      }

      return data.map(function (item, i) {
        return h(drag_list_item, {
          "attrs": {
            "index": i,
            "data": item
          },
    ...
    return h("div", {
      "class": "cqc-drag-list",
      "ref": 'instanceNode'
    }, [renderChild(this.cloneData), h("div", {
      "class": "cqc-drap-inditcator",
      "style": this.showInditcator
    })]);
  }
});
...
drag_list.install = function (app) {
  return app.component(drag_list.name, drag_list);
};

/* harmony default export */ var packages_drag_list = (drag_list);
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/packages/carousel/carousel.vue?vue&type=template&id=1f5a0125&
var carouselvue_type_template_id_1f5a0125_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"cqc-carousel",on:{"mouseenter":_vm.handleMouseenter,"mouseleave":_vm.handleMouseleave}},[_c('div',{staticClass:"cqc-carousel-wrap",style:(_vm.style)},[_vm._t("default")],2),(_vm.showDots)?_c('div',{staticClass:"cqc-carousel-dots"},_vm._l((_vm.len),function(item){return _c('span',{key:item,class:['dot', { active: _vm.currentSelected === item - 1 }],on:{"click":function($event){return _vm.go(item - 1)}}})}),0):_vm._e(),(_vm.showBtn)?[_c('div',{staticClass:"cqc-carousel-prev-btn"},[_c('Button',{attrs:{"icon":"cqc-icon-shuangjiantou-zuo"},on:{"click":function($event){return _vm.go(_vm.currentSelected - 1, true)}}})],1),_c('div',{staticClass:"cqc-carousel-next-btn"},[_c('Button',{attrs:{"icon":"cqc-icon-shuangjiantou-you"},on:{"click":function($event){return _vm.go(_vm.currentSelected + 1, true)}}})],1)]:_vm._e()],2)}
var carouselvue_type_template_id_1f5a0125_staticRenderFns = []
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-80[0].rules[0].use[1]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/packages/carousel/carousel.vue?vue&type=script&lang=js&
//
//
//
//
    ...
    run: function run() {
      ...
      if (this.autoplay) {
        this.timer = setInterval(function () {
          var index = _this.currentSelected;
          var newIndex = _this.reverse ? index - 1 : index + 1;

          _this.go(newIndex, index);
        }, this.delay + this.duration);
      }
    },
    go: function go(newIndex, flag) {
      var _this2 = this;

      var index = this.currentSelected; // 临界条件，到了最后一张的下一张就是第一张， 第二张的前一张就是最后一张

      if (newIndex === this.len) newIndex = 0;
      if (newIndex === -1) newIndex = this.len - 1; // 根据上一次的值和当前值 判断是正向还是反向
      ...
      this.$nextTick(function () {
        setTimeout(function () {
          _this2.currentSelected = newIndex;

          _this2.$emit('change', newIndex);
        }, 0);
      });
    },
...
var carousel_component = normalizeComponent(
  ...
  carouselvue_type_template_id_1f5a0125_render,
  carouselvue_type_template_id_1f5a0125_staticRenderFns,
  false,
  null,
  null,
  null
...
carousel.install = function (app) {
  return app.component(carousel.name, carousel);
};

/* harmony default export */ var packages_carousel = (carousel);
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/packages/carousel-item/carousel-item.vue?vue&type=template&id=52aaea57&
var carousel_itemvue_type_template_id_52aaea57_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"carousel"}},[(_vm.isVisible)?_c('div',{staticClass:"cqc-carousel-item",class:_vm.classs,style:(_vm.styles)},[_vm._t("default")],2):_vm._e()])}
var carousel_itemvue_type_template_id_52aaea57_staticRenderFns = []


;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-80[0].rules[0].use[1]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/packages/carousel-item/carousel-item.vue?vue&type=script&lang=js&
//
//
//
//
...
var carousel_item_component = normalizeComponent(
  ...
  carousel_itemvue_type_template_id_52aaea57_render,
  carousel_itemvue_type_template_id_52aaea57_staticRenderFns,
  false,
  null,
  null,
  null
...
carousel_item.install = function (app) {
  return app.component(carousel_item.name, carousel_item);
};

/* harmony default export */ var packages_carousel_item = (carousel_item);
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/packages/preview-img/preview-img.vue?vue&type=template&id=a5a29e10&
var preview_imgvue_type_template_id_a5a29e10_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"cqc-preview-img",on:{"click":_vm.handleClose}},[_c('div',{staticClass:"cqc-preview-img-content",style:({transform: _vm.transform}),on:{"click":function($event){$event.stopPropagation();}}},[_c('div',{staticClass:"cqc-preview-img-title"},[_vm._v(_vm._s(_vm.current + 1)+" / "+_vm._s(_vm.imgArr.length))]),_c('div',{staticClass:"cqc-preview-img-wrap",style:({ width: _vm.width + 'px', height: _vm.height + 'px'})},[_c('div',{staticClass:"cqc-preview-img-list",style:({transform: ("translate(" + _vm.translate + "px)")})},[_vm._l((_vm.imgArr),function(img,i){return [_c('img',{key:i,staticClass:"cqc-preview-img-item",style:({ width: _vm.width + 'px', height: _vm.height + 'px'}),attrs:{"src":img}})]})],2)]),_c('i',{staticClass:"cqc-preview-img-close cqc-icon-guanbi1",on:{"click":function($event){$event.stopPropagation();return _vm.handleClose.apply(null, arguments)}}}),_c('button',{staticClass:"cqc-preview-img-btn cqc-preview-img-prev",attrs:{"disabled":(_vm.current === _vm.imgArr.length - 1) || _vm.imgArr.length === 0},on:{"click":function($event){$event.stopPropagation();return _vm.handleChangeIndex(_vm.current+1)}}},[_c('i',{staticClass:"cqc-icon-left"})]),_c('button',{staticClass:"cqc-preview-img-btn cqc-preview-img-next",attrs:{"disabled":(_vm.current === 0) || _vm.imgArr.length === 0},on:{"click":function($event){$event.stopPropagation();return _vm.handleChangeIndex(_vm.current-1)}}},[_c('i',{staticClass:"cqc-icon-right"})])])])}
var preview_imgvue_type_template_id_a5a29e10_staticRenderFns = []
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-80[0].rules[0].use[1]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/packages/preview-img/preview-img.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var preview_imgvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleChangeIndex: function handleChangeIndex(cur) {
  ...
  mounted: function mounted() {
    ...
    setTimeout(function () {
      _this2.transform = 'scale(1)';
    }, 0);
  }
});
;// CONCATENATED MODULE: ./src/packages/preview-img/preview-img.vue?vue&type=script&lang=js&
 /* harmony default export */ var preview_img_preview_imgvue_type_script_lang_js_ = (preview_imgvue_type_script_lang_js_); 
...
/* normalize component */
;
var preview_img_component = normalizeComponent(
  preview_img_preview_imgvue_type_script_lang_js_,
  preview_imgvue_type_template_id_a5a29e10_render,
  preview_imgvue_type_template_id_a5a29e10_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var preview_img = (preview_img_component.exports);
...
function PreviewImg(imgArr) {
  var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var app = null;

  opts.closeCb = function () {
    document.body.removeChild(app.$el);
    app.$destroy();
  };

  var PreviewPlugin = external_commonjs_vue_commonjs2_vue_root_Vue_default().extend(preview_img);
  app = new PreviewPlugin({
...
var cavClientLeft, cavClientTop, canvas, ctx;
function drawEvents(vm, canvasRef) {
  var flag = true;
  var lineWidth = vm.lineWidth,
      strokeStyle = vm.strokeStyle,
      lineCap = vm.lineCap,
      lineDash = vm.lineDash,
      doubleLine = vm.doubleLine,
      miniType = vm.miniType,
      canvasBg = vm.canvasBg,
      width = vm.width,
      height = vm.height;
  ...
  function preview() {
    var baseImg = vm.$refs[canvasRef].toDataURL(miniType);
...
/* harmony default export */ var sign_board = ({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      setTimeout(function () {
        var _drawEvents = drawEvents(_this, 'canvasRef'),
            init = _drawEvents.init;
  ...
  render: function render() {
    ...
    var _drawEvents2 = drawEvents(this, 'canvasRef'),
        clear = _drawEvents2.clear,
        getData = _drawEvents2.getData,
        preview = _drawEvents2.preview;

    var confirm = function confirm() {
      _this2.$emit('getData', getData());
    };
    ...
    }, ["\u6E05\u7A7A"]), this.previewBtn && h("span", {
      "style": 'padding:4px'
    }), this.previewBtn && h(packages_button, {
      "attrs": {
        "type": "primary"
      },
      "on": {
...
sign_board.install = function (app) {
  return app.component(sign_board.name, sign_board);
};
...
var plugins = [packages_loading_icon, packages_button, packages_button_group, packages_progress, packages_drag_list, packages_carousel, packages_carousel_item, packages_sign_board];
